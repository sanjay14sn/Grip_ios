...
class TTextStyles {
  ...
  static final TextStyle Rivenrefsmall = GoogleFonts.roboto(
    ...
    static final TextStyle tkRivenrefsmall = GoogleFonts.roboto(
    color: Color(0xFF828282),
    fontSize: 16.sp,
    fontWeight: FontWeight.w600,
  );
  ...
  static final TextStyle reftext = GoogleFonts.roboto(
    ...
    static final TextStyle tktext = GoogleFonts.roboto(
    color: Colors.black,
    fontSize: 18.sp,
  ...
  static final TextStyle refname = GoogleFonts.roboto(
    ...
    static final TextStyle tkname = GoogleFonts.roboto(
    color: Colors.white,
    fontSize: 16.sp,
    fontWeight: FontWeight.w600,
  );
