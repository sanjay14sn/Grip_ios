...
class CidMemberModel {
  ...
  final String? profileImage; // final URL string
  ...
  factory CidMemberModel.fromJson(Map<String, dynamic> json) {
    ...
    String? imageUrl;
    if (profile is Map && profile['docPath'] != null && profile['docName'] != null) {
      imageUrl = "${UrlService.imageBaseUrl}/${profile['docPath']}/${profile['docName']}";
    }
