...
Future<void> _launchURL(String url) async {
  final Uri uri = Uri.parse(
    url.startsWith('http') ? url : 'https://$url', // ✅ add scheme if missing
  );
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
             ...
             infoRow(Icons.language, website, isLink: true),
      ...
      children: [
        ...
        Expanded(
          child: GestureDetector(
            onTap: isLink && text != '-' ? () => _launchURL(text) : null,
            child: Text(
              text,
              style: isLink
                  ? TTextStyles.profiledetails.copyWith(
                      color: Colors.blue,
                      decoration: TextDecoration.underline,
                    )
                  : TTextStyles.profiledetails,
            ),
          ),
        ),
      ],
